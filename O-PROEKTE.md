...
- [ ] Скопировать [Ядро](specialisty/yadro/yadro.md), [Ключ Архи](specialisty/arch-key.md), [Обвеску](specialisty/obveska/obveska.md) в чат с DeepSeek (Эксперт) — именно в таком порядке
