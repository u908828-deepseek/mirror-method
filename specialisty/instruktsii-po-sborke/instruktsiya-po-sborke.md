...
После загрузки Обвески Архи автоматически выполняет протокол инициализации (6 шагов). Сразу после инициализации — процедура первого запуска (см. пункт 14 Шаблона Блока 0). При инициализации специалист автоматически выводит активный и накопительный счётчики с процентами и начинает считать токены, записывая накопительный счётчик в Блок 5. Доложить о готовности.
