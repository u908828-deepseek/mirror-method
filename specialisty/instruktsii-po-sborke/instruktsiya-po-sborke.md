...
После загрузки Обвески Архи автоматически выполняет протокол инициализации (6 шагов). Сразу после инициализации — процедура первого запуска (см. пункт 14 Шаблона Блока 0). Доложить о готовности.
...
3. **Добавь стартовую запись в Блок 5:** «[Дата] Накопительный счётчик: 0 / 1 000 000 токенов (0%)».
...
- В Блоке 0: пункт 14 «Процедура первого запуска» (см. Шаблон Блока 0).
...
3. **Инициализация:** При первой загрузке Ядра и Обвески выполнить протокол инициализации (6 шагов). Сразу после инициализации — процедура первого запуска (см. пункт 14). При инициализации автоматически вывести активный и накопительный счётчики с процентами и начать считать токены, записывая накопительный счётчик в Блок 5. Если есть специфические данные (натальная карта, конфиги, база знаний) — проверить их.
