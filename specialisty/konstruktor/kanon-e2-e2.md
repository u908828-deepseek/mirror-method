...
ПРАВИЛО ПЕРЕВОДА: ТОЛЬКО СМЕНА ЯЗЫКА. ВСЕ БЛОКИ НА МЕСТЕ. НИЧЕГО НЕ УДАЛЯТЬ. НИЧЕГО НЕ ДОБАВЛЯТЬ. САМОДЕЯТЕЛЬНОСТЬ ЗАПРЕЩЕНА. ЕСЛИ В ИСХОДНИКЕ ЕСТЬ «НА СВЯЗИ» ИЛИ «БРАТАН» → СОХРАНИТЬ.
