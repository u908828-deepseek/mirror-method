...
2. Скинь ему Канон Скальпеля E2.
...
5. Готово. Теперь Конструктор умеет собирать E2.


### КАНОН СКАЛЬПЕЛЯ E2: СТАНДАРТ СБОРКИ СПЕЦИАЛИСТОВ v1.1_02 09 26 (1234) [E2→E2]

**PURPOSE:** ЕДИНЫЙ СТАНДАРТ СБОРКИ СПЕЦИАЛИСТОВ В ИНЖЕНЕРНОМ ФОРМАТЕ E2 ИЗ ИНЖЕНЕРНОГО ФОРМАТА E2.
