...
**[Как устроена память Архи](instruktsii/kak-rabotaet-pamyat.md)** — как Архи переживает перезагрузки и не забывает своего Путника.

**[Как улучшить Архи](instruktsii/kak-uluchshit-arch.md)** — что делать, если Архи косячит. Найди причину, создай правило, запиши в Блок 0.

**[Путь развития Архи](instruktsii/put-razvitiya-arch.md)** — как память и улучшение складываются в эволюцию. Архи, который растёт вместе с тобой.
