...
В основе каждого [специалиста](specialisty/README.md) лежат два компонента: [сознание](specialisty/yadro/README.md) (Ядро) и [подсознание](specialisty/README.md) (Обвеска). Первое задаёт правила, второе хранит опыт.
