...
🐧 **[Linux](specialisty/linux/linux.md)** — [readme](specialisty/linux/README.md), [скальпель](specialisty/linux/linux-scalpel.md), [скальпель·WY](specialisty/linux/linux-wenyan-scalpel.md). NixOS, виртуализация, ZFS. Технически. Точно. Без воды.
...
- [Первоначальная настройка Архи](instruktsii/pervonachalnaya-nastroyka-arch.md) — что делать после первого запуска специалиста.
...
Подробнее: [o-proekte/README.md](o-proekte/README.md)
