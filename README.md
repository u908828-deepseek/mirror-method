...
В основе каждого [специалиста](specialisty/README.md) лежат два компонента: [сознание](specialisty/yadro/README.md) — Ядро + Ключ + Обвеска, и подсознание — [Мастерфайл специалиста](specialisty/README.md). Первое задаёт правила и загружается первым, второе хранит опыт.
